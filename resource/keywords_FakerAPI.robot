*** Settings ***
DOCUMENTATION    Praticing concepts: keyword file implementing tests cases
...
#GET keywords
List a specifc book ID=
    [Documentation]                              Testing "GET request" that will return the book with specific ID
    [Arguments]                                  ${id_book}
